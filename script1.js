...
['9) What is the result of logical or relational expression in C?','True or False','0 or 1','0 if an expression is false and any positive number if an expression is true','None of the mentioned'],
['10) Which among the following is NOT a logical or relational operator?','!=','==','||','='],
['11) Relational operators cannot be used on ____________','structure','long','strings','float'],
['12) function tolower(c) defined in library <ctype.h> works for ___________',' Ascii character set','Unicode character set','Ascii and utf-8 but not EBCDIC character set','Any character set'],
['13) Which type of conversion is NOT accepted?','From char to int','From float to char pointer','From negative int to char',' From double to char'],
['14) Which of the following type-casting have chances for wrap around?','From int to float','From int to char',' From char to short',' From char to int'],
...
['16) For which of the following, “PI++;” code will fail?','#define PI 3.14','char *PI = “A”;','float PI = 3.14;','none of the Mentioned'],
